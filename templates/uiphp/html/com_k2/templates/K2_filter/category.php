...
if (file_exists(JPATH_SITE .  '/templates/' . $template . '/html/com_k2/templates/ja_k2filter/css/style.css')) {
 JHTML::stylesheet('templates/' . $template . '/html/com_k2/templates/ja_k2filter/css/style.css');
} elseif(file_exists(JPATH_SITE .  '/templates/' . $template . '/html/com_k2/ja_k2filter/css/style.css')) {
 JHTML::stylesheet('templates/' . $template . '/html/com_k2/ja_k2filter/css/style.css');
} else {
 JHTML::stylesheet('components/com_k2/templates/ja_k2filter/css/style.css');
}
